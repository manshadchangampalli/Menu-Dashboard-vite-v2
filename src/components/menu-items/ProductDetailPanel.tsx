...
import { useDeleteProduct } from "../../pages/menu-items/hooks/useProducts";
...
const ProductDetailPanel = ({ item, open, onClose, onEdit }: ProductDetailPanelProps) => {
                    ...
                    {allMedia.length > 0 && (
                        <Section title={`Media (${allMedia.length})`} icon={<ImageIcon className="size-3" />}>
                            ...
                            <div className="relative bg-app-bg border border-app-border rounded-xl overflow-hidden aspect-video flex items-center justify-center">
                                ...
                                {allMedia.length > 1 && (
                                    <>
                                        <button onClick={prevMedia} className="absolute left-2 top-1/2 -translate-y-1/2 size-8 bg-white/80 hover:bg-white border border-app-border rounded-full flex items-center justify-center shadow-sm transition-all">
                                            <ChevronLeft className="size-4" />
                                        </button>
                                        <button onClick={nextMedia} className="absolute right-2 top-1/2 -translate-y-1/2 size-8 bg-white/80 hover:bg-white border border-app-border rounded-full flex items-center justify-center shadow-sm transition-all">
